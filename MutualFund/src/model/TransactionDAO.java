...
public class TransactionDAO extends GenericDAO<TransactionBean>{
	 ...
	 * @return TransactionBean[] 
	 */
	public TransactionBean[] getTransactionByType(String type) throws RollbackException{
		try{
			Transaction.begin();
			TransactionBean[] newBeanArray = match(MatchArg.equals("transaction_type",type));
	 ...
	 * @return TransactionBean[] 
	 */
	public TransactionBean[] getTransactionByDate(String execute_date) throws RollbackException{
		try{
			Transaction.begin();
